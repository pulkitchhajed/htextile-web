...
<title>Commission Receipt Search</title>
...
<script>
  function payment_search_submit(){
    document.getElementById('payment_report').action='s_commission_receipt_search.php';
...
$search_agent_code="";
if(isset($_REQUEST['search_agent_account_code'])){
            ...
            <div class="content_padding">
              <div class="content-header">
                <table width="100%" border='0'><tr>
                  <td width="25%" ><h3>Commission Receipt Search :</h3></td>
              ...
              <table class="tbl_border">
                <tr>
                  ...
                  <td>
                      <select name="search_agent_account_code" id="search_agent_account_code">
                          <option value="">All</option>
                            <?php
                              ...
                              {
                                $selected="";
                                if($search_agent_code==$s_rs['company_id'])
                                {
                                  $selected="selected";
                                }
                                echo "<option $selected value='".$s_rs['company_id']."'>".$s_rs['firm_name']."</option>";
                ...
                <tr><td colspan='4'> <span class="astrik">*</span> Report will be displayed in order of <b> Receipt Date </b></td></tr>
              ...
              <?php include("s_commission_receipt_search_display.php"); ?>   
              <?php } }?>           
            </div>                                 
          </td>
        </tr>
