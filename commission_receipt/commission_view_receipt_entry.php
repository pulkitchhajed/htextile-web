...
<table width="100%" border="0" align="center" style="border:0px solid #e5f1f8;background-color:#FFFFFF">
	...
	<tr>
		...
		<td align="center" ><input type="text" disabled   name="receipt_date" class="datepick" id="receipt_date" value="<?php echo rev_convert_date($receipt_date);?>" size="8"></td>
		...
		<select disabled name="receipt_type" id="receipt_type">
		...
		<select disabled name="receipt_mode" id="receipt_mode">
        		<option value="">--Select--</option>
				<?php
	...
	<TD align="center">
		...
		<input  type="text" size='6' disabled name="receipt_amount" id="receipt_amount"  value="<?php echo $receipt_amount;?>" >
	</TD>
	<TD align="center"><input  type="text" sixe='6' disabled name="bank_name" id="bank_name"  value="<?php echo $bank_name; ?>"  ></TD>
	<TD align="center"><input  type="text" sixe='6' disabled name="cheque_number" id="cheque_number"  value="<?php echo $cheque_number; ?>"  ></TD>
	...
	<TD align="center">
		...
		<input   type="text" size='6' disabled name="deduction_amount" id="deduction_amount"  value="<?php echo $deduction_amount; ?>" ></TD>
	<td colspan='2' align="center" width="150"><textarea disabled name="narration" id="narration"  cols="60" rows="1"><?php echo $narration; ?></textarea></td>
...
<tr style='background-color:#f0f5f4f3'>	
				...
				<td><select disabled  name="receipt_part_full[]" id="receipt_part_full" >
					<option value="">Select</option>
					<?php 
				...
				<td>
				<select disabled  name="receipt_bill_pay[]" id="receipt_bill_pay" >
				...
				<td><input type="text" size="6" disabled onblur="calculateDeductionAmt()" name="deduction_amt[]" id="deduction_amt" value="<?php echo $rs['deduction_amount'] ?>"  size="10" onkeypress="return isNumberKey(event)" ></td>

				<td><input type="text" size="6" disabled  onblur="calculateRecdAmt()" name="bill_received_amt[]" id="bill_received_amt" value="<?php echo $rs['received_amount'] ?>" size="10" onkeypress="return isNumberKey(event)" ></td>

				<td><input type="text" disabled size="6" name="bill_bal_amt[]" id="bill_bal_amt" size="10" value="<?php echo $rs['balance_amount']; ?>"></td>
				<td><textarea disabled name="bill_remarks[]"  id="bill_remarks" cols="10" rows="2"></textarea></td>
				</tr>
