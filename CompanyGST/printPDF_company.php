...
<table width="100%" border="0" align="center" style="border:1px solid #e5f1f8;background-color:#FFFFFF">
  ...
  <tr>
    ...
    <tr>
    	<th width="80" align="left">Firm Name</th>
        <td width="600"> <?php echo $rs['firm_name']; ?> <input disabled name="firm_name" type="hidden" id="firm_name" value="<?php echo $rs['firm_name']; ?>" size="60"></td>
