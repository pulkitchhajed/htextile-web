...
$rs=mysqli_fetch_array($result);
?>
   <table width="718"> <tr><td align='Right'><input  type="button" class="form-button" onclick="pdfDownLoad()" name="ls_dnload" value="Print GST" /> &nbsp;<input  type="button" class="form-button" onclick="pdfDownLoadDetail()" name="ls_dnload" value="Print GST & Contact Details" /></td></tr> </table>
