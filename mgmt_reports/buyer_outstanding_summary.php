...
<title>Buyer OS Summary Report</title>
...
<script>
  function buyer_os_summary_report_submit(){
      
      document.getElementById('comm_detail_report').action='buyer_outstanding_summary.php';
  ...
  function excelDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){
      document.getElementById('comm_detail_report').action='buyer_os_summary_display_xls.php';
      document.getElementById('comm_detail_report').target="_self";
      document.getElementById('comm_detail_report').submit();
    }else{
  ...
  function pdfDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){    
        document.getElementById('comm_detail_report').action='buyer_os_summary_display_print.php';
...
$buy_os_report_type="";
if(isset($_REQUEST['buy_os_report_type'])){
          ...
          <td valign="top">
            <div class="content_padding">
              <div class="content-header">
                <table width="100%" border='0'><tr><td><h3>Buyer Outstanding Summary Report :</h3></td></tr></table>
              </div>
              ...
              <table class="tbl_border">
                ...
                <th align="left"> Order By </th>
                    ...
                    <td>
                        <select onchange='downloadLock()' name="buy_os_report_type" id="buy_os_report_type">
                              <?php
                                  $arr=array('Buyer Name','Buyer Group','Outstanding Amount','Sales Amount',"GR Amount");

                                  foreach($arr as $v)
                                  {
                                      $selected="";
                                      if($v==$buy_os_report_type){
                                          $selected="selected";
                                      }
              ...
              <tr>
                <td>
                <input  type="button" class="form-button" onclick="buyer_os_summary_report_submit()" name="my_btn" value="Go" />
                </td></tr>
              </table>
              ...
              <?php include("buyer_os_summary_display.php"); ?>   
              <?php } } ?>           
            </div>                                 
          </td>
        </tr>
