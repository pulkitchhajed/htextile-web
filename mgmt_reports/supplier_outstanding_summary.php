...
<title>Supplier OS Summary Report</title>
...
<script>
  function comm_detail_report_submit(){
      ...
      document.getElementById('comm_detail_report').action='supplier_outstanding_summary.php';
  ...
  function excelDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){
      document.getElementById('comm_detail_report').action='supplier_os_summary_display_xls.php';
      document.getElementById('comm_detail_report').target="_self";
      document.getElementById('comm_detail_report').submit();
    }else{
  ...
  function pdfDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){    
        document.getElementById('comm_detail_report').action='supplier_os_summary_display_print.php';
...
$supp_os_report_type="";
if(isset($_REQUEST['supp_os_report_type'])){
          ...
          <td valign="top">
            <div class="content_padding">
              <div class="content-header">
                <table width="100%" border='0'><tr><td><h3>Supplier Outstanding Summary Report :</h3></td></tr></table>
              </div>
              ...
              <table class="tbl_border">
                ...
                <th align="left"> Order By </th>
                    ...
                    <td>
                        <select onchange='downloadLock()' name="supp_os_report_type" id="supp_os_report_type">
                              <?php
                                  $arr=array('Supplier Name','Supplier Group','Outstanding Amount','Sales Amount',"GR Amount");

                                  foreach($arr as $v)
                                  {
                                      $selected="";
                                      if($v==$supp_os_report_type){
                                          $selected="selected";
                                      }
              ...
              <?php include("supplier_os_summary_display.php"); ?>   
              <?php } } ?>           
            </div>                                 
          </td>
        </tr>
