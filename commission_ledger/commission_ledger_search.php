...
<title> Commission Ledger Search</title>
...
<script>
  function check(){
    ...
    if(document.getElementById('agent_account_code').value == ""){
  ...
  function report_submit(){
    if(check()){
      document.getElementById('report').action='commission_ledger_search.php';
  ...
  function excelDownLoad(){
    if(check()) {
      if(document.getElementById('download_lock').value=='OFF'){
        document.getElementById('report').action='commission_ledger_search_display_xls.php';
        document.getElementById('report').target="_self";
        document.getElementById('report').submit();
      }else{
  ...
  function pdfDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){    
        document.getElementById('report').action='commission_ledger_search_display_print.php';
  ...
  {    
      ...
      var url="<?php echo $web_path ?>"+"commission_bill_entry/commission_edit_bill_entry.php?disp=child&commission_bill_entry_id="+bill_entry;
      //alert (url);
  ...
  {    
      ...
      var url="<?php echo $web_path ?>"+"commission_receipt/commission_edit_receipt_entry.php?disp=child&receipt_entry_id="+pay_entry;
      //alert (url);
      popupWindow=window.open(url,'Edit Receipt Entry','width=560,height=340,toolbar=0,menubar=0,location=0');  
      if (window.focus) {popupWindow.focus()}
  }
  ...
  {    
      ...
      var url="<?php echo $web_path ?>"+"commission_bill_entry/commission_view_bill_entry.php?disp=child&commission_bill_entry_id="+bill_entry;
      //alert (url);
      popupWindow=window.open(url,'View Bill Entry','width=560,height=340,toolbar=0,menubar=0,location=0');  
      if (window.focus) {popupWindow.focus()}
  }
  ...
  {    
      ...
      var url="<?php echo $web_path ?>"+"commission_receipt/commission_view_receipt_entry.php?disp=child&receipt_entry_id="+pay_entry;
      //alert (url);
      popupWindow=window.open(url,'View Receipt Entry','width=560,height=340,toolbar=0,menubar=0,location=0');  
      if (window.focus) {popupWindow.focus()}
  }
...
if(isset($_REQUEST['agent_account_code'])){
  $agent_code=$_REQUEST['agent_account_code'];
}
            ...
            <div class="content_padding">
              ...
              <table class="tbl_border">
                <tr>
                  ...
                  <td>
                      <select onchange='downloadLock()' name="agent_account_code" id="agent_account_code">
                          <option value="">All</option>
                            <?php
...
<!--                <tr><td colspan='4'> <span class="astrik">*</span> Report will be displayed in order of Supplier <b> Grouped by Buyer </b></td></tr> -->
              ...
              <?php include("commission_ledger_search_display.php"); ?>   
              </td></tr></table>
              <?php } } ?>           
            </div>                                 
          </td>
