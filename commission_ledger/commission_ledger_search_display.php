...
$agent_condition="";
if($rep_agent_code!=''){
  $agent_condition=" AND agent_account_code='$rep_agent_code' ";
}
...
$sql_ledger=" SELECT entry_id ,
                     ...
                     pay_amt
                FROM 
                ( SELECT receipt_entry_id AS entry_id      ,
                         receipt_type     AS vou_type      ,
                         ''               AS pay_type      ,
                         ''               AS bill_vou_date ,
                         receipt_date     AS vou_date      ,
                         ''               AS bill_number   ,
                         receipt_entry_id AS vou_number    ,
                         agent_account_code                ,
                         supplier_account_code             ,
                         ''             AS bill_amount         ,
                         receipt_amount AS pay_amt
                    FROM txt_commission_receipt_entry_main 
                    ...
                    receipt_entry_id AS entry_id      ,
                        ...
                        supplier_account_code             ,
                        ''             AS bill_amount         ,
                        deduction_amount AS pay_amt                    

                    FROM txt_commission_receipt_entry_main 
                    WHERE delete_tag='FALSE' AND deduction_amount>0
                    $agent_condition 
                    $supplier_condition
                    ...
                    UNION
                    SELECT  
                    commission_bill_entry_id AS entry_id      ,
                        'Bill'                   AS vou_type      ,
                        ''                       AS pay_type      ,
                        commission_bill_date     AS bill_vou_date ,
                        commission_bill_date     AS vou_date      ,
                        commission_bill_number   AS bill_number   ,
                        commission_bill_entry_id AS vou_number    ,
                        agent_account_code                        ,
                        supplier_account_code                     ,
                        commission_amt_bill             AS bill_amount         ,
                        '' AS pay_amt                    
                    FROM txt_commission_bill_entry 
                    WHERE delete_tag='FALSE'  and commission_mode ='Bill Wise'
                    ...
                    commission_bill_entry_id AS entry_id      ,
                        ...
                        agent_account_code                        ,
                        supplier_account_code                     ,
                        commission_amt_pay             AS bill_amount         ,
                        '' AS pay_amt                    
                    FROM txt_commission_bill_entry 
                    WHERE delete_tag='FALSE'  and commission_mode ='Payment Wise'
                ...
                ( SELECT buy.company_id AS buy_company_id,
                  ...
                  AND firm_type='agent' 
                  ORDER BY firm_name) AS agent
                WHERE supplier_account_code=supp_company_id
                AND agent_account_code=buy_company_id
...
<th align='center' colspan='".($col_span)."'> 
Agent : ".array_search($_REQUEST['agent_account_code'],$company_array)."
 </th> </tr>
...
/*
    ...
    */
    ...
    if($rs['vou_type']=="Bill"){
      echo "<td>&nbsp;";  
      echo $rs['vou_type'] . "---" .$rs['bill_number'] ."---".$rs['entry_id'];
      echo "&nbsp;</td>"; 
