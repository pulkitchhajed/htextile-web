...
<title>Commission OS Report Supplier Wise</title>
...
<script>
  ...
  function report_submit(){
    ...
    //if(check()){
      document.getElementById('report').action='supplier_commission_outstanding.php';
  ...
  function excelDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){
        document.getElementById('report').action='supplier_commission_outstanding_report_display_xls.php';
        document.getElementById('report').target="_self";
      //  document.getElementById('report').onsubmit="";
        document.getElementById('report').submit();
    }else{
  ...
  function pdfDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){    
        document.getElementById('report').action='supplier_commission_outstanding_report_display_print.php';
          ...
          <td valign="top">
            <div class="content_padding">
              <div class="content-header">
                <table width="100%" border='0'><tr><td><h3>Commission OS Supplier Wise :</h3></td></tr></table>
              </div>
      ...
      <td>
          <select onchange='downloadLock()' name="agent_account_code" id="agent_account_code">
              <option value="">All</option>
                ...
                <tr><td colspan='4'> <span class="astrik">*</span> Report will be displayed grouped by Agent </td></tr>
              ...
              <?php include("supplier_commission_outstanding_report_display.php"); ?>   
              <?php } }?>           
            </div>                                 
          </td>
        </tr>
