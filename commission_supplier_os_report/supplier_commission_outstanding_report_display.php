...
$sql_pay.= " ORDER by supp_firm_name,agent_firm_name,commission_bill_date,commission_bill_number ) AS t1
        LEFT JOIN 
        ...
        ORDER BY  supp_firm_name,agent_firm_name,commission_bill_date ,commission_bill_number ";
...
<?php
    ...
    <td  valign='top'><b>Comm Year</b>
    </td>
    <td  width='80' valign='top'><b>Bill Date</b>
    </td>
    <td  width='80' valign='top'><b>Comm Type</b>
    </td>
...
//<p style="page-break-before: always">
      if( $old_bill_entry_id==0){
        ...
        //Supplier  // Supplier To Agent
        echo "<tr> <td  colspan='".($col_span*2)."' align='left' ><b>".trim($rs['agent_firm_name'])."</b></td> 
        </tr>";
...
//          echo "</td>";
        ...
        if($rs['agent_account_code']!=$old_agent_code && $old_bill_entry_id!=0){  // to change to Agent
        ...
        if($rs['supplier_account_code']!=$old_supplier_code && $old_bill_entry_id!=0){  // to Change to Supplier
        ...
        if($row_count>$page_size && $rep_print=="OK"){
          ...
          echo "<tr> <td  colspan='".($sub_colspan-1)."' align='Right' ><b>Total </b></td> 
        ...
        $supplier_subtotal='YES';
        $supplier_header=""; // Change to Supplier Header
        if($rs['supplier_account_code']!=$old_supplier_code && $old_bill_entry_id!=0){ // To change to Supplier
        ...
        if($rep_xls!="OK"){
          ...
          <?php   
          $s_no=1; 
          $supplier_header="NEW";  // Change to Supplier Header
        }
        if(($rs['agent_account_code']!=$old_agent_code && $old_bill_entry_id!=0) || $supplier_header=="NEW"){ // to change to Agent  // to supplier_header
          //echo "<tr> <td colspan='".($col_span*2)."' >-------------------------------------------------</td></tr>";

          if( $supplier_header!="NEW"){  // Change to Supplier Header
...
*/
        ...
        $supplier_header="OLD"; // Change to Supplier Header
