...
function save() 
{
	...
	if(($_REQUEST['firm_name']) && ($_SESSION['uid']==77)) 
	{
        ...
        if($file_size1 > 2097152){
			...
			$upload_result = supabase_upload_file($file_tmp1, "company/" . $file_name1, $file_type1);
			if (!$upload_result['success']) { error_log("Supabase upload failed: " . $upload_result['error']); }
			$visiting_card="company/".$file_name1;
		}
...
function update()
{
	...
	if(($_REQUEST['firm_name']) && ($_SESSION['uid']==77)) 
	{
		...
		//comm_stat_pref_last_update
		$comm_stat_pref_last_update=$_REQUEST['comm_stat_pref_last_update'];

		// pan_card_file_name1
		$pan_card_file_name1=$_REQUEST['pan_card_file_name1'];
		$pan_card_file_name2=$_REQUEST['pan_card_file_name2'];
		$pan_card_file_name3=$_REQUEST['pan_card_file_name3'];
		...
		$sql .= " comm_stat_pref_last_update='$comm_stat_pref_last_update',";
		$sql .= " pan_card_file_name1='$pan_card_file_name1',";
		$sql .= " pan_card_file_name2='$pan_card_file_name2',";
		$sql .= " pan_card_file_name3='$pan_card_file_name3',";	
