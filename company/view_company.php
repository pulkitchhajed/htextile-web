...
function pdfDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){    
        document.getElementById('viewcompany').action='printPDF_companyPrint.php?company_id=<?php echo $company_id ?>';
        document.getElementById('viewcompany').target="print_popup";
  ...
  function pdfDownLoadDetail(){
    if(document.getElementById('download_lock').value=='OFF'){    
        document.getElementById('viewcompany').action='printPDF_companyPrintDetail.php?company_id=<?php echo $company_id ?>';
        document.getElementById('viewcompany').target="print_popup";
        window.open('','print_popup','menubar=no,addressbar=no, width=1000,height=800,resizable=yes,toolbar=no,status=no');
        document.getElementById('viewcompany').submit();
    }else{
  ...
  function pdfDownLoadBank(){
    if(document.getElementById('download_lock').value=='OFF'){    
        document.getElementById('viewcompany').action='printPDF_companyBank.php?company_id=<?php echo $company_id ?>';
        document.getElementById('viewcompany').target="print_popup";
        window.open('','print_popup','menubar=no,addressbar=no, width=1000,height=800,resizable=yes,toolbar=no,status=no');
        document.getElementById('viewcompany').submit();
    }else{
...
<tr>
  ...
  <tr>
    <td height="326" valign="top"><table width="100%" style="margin-top:0px" align="center" cellpadding="0" cellspacing="0" border="0">
            ...
            <table width="100%"><tr><td><h3>View Company :</h3></td>
    ...
    <form method="post" id="viewcompany" enctype="multipart/form-data" >
    <?php
	$company_id=$_REQUEST['company_id'];
$sql="select * from txt_company where company_id='$company_id'";
...
$rs=mysqli_fetch_array($result);
?>
   <table width="718"> <tr><td align='Right'>
   <input  type="button" class="form-button" onclick="pdfDownLoadBank()" name="ls_dnload" value="Print Bank Details" /> &nbsp;
   	<input  type="button" class="form-button" onclick="pdfDownLoad()" name="ls_dnload" value="Print GST" /> &nbsp;
   	<input  type="button" class="form-button" onclick="pdfDownLoadDetail()" name="ls_dnload" value="Print GST & Contact Details" />  &nbsp;
    ...
    <tr>
        ...
        <td width="244">
			<input disabled name="firm_name" type="text" id="firm_name" value="<?php echo $rs['firm_name']; ?>" size="60">
			<input type=hidden name='disp_firm_name' id='disp_firm_name' value="<?php echo $rs['firm_name']; ?>">
		</td>
    </tr>
    <tr>
	...
	<tr>
	<th align="left"> Commission Statement Preference
	</th>
	<td>
		<select disabled name="comm_stat_pref" id="comm_stat_pref">

		<?php

			$arr=array('NotApplicable','BillWise','PaymentWise');
	...
	<tr>
    	<th align="left">Commission Statement Remark</th>
        <td><input disabled name="comm_stat_pref_last_update" type="text" id="comm_stat_pref_last_update" value="<?php echo $rs['comm_stat_pref_last_update']; ?>" size="40"></td>
    </tr>
	<?php } ?>
	<tr>
	...
	<?php if (($rs['firm_type']=="Agent") && (($_SESSION['ROLEID']=='admin' || $_SESSION['ROLEID']=='master' ) ) ){ ?>

<tr>
	<th width="317" align="left">PAN Number File Name 1</th>
	<td><input disabled type="text" name="pan_card_file_name1" id="pan_card_file_name1"  value="<?php echo $rs['pan_card_file_name1']; ?>" size="40" ></td>
</tr>


<tr>
	<th align="left">PAN Number File Name 2</th>
	<td><input disabled type="text" name="pan_card_file_name2" id="pan_card_file_name2"  value="<?php echo $rs['pan_card_file_name2']; ?>" size="40" ></td>
</tr>

<tr>
	<th align="left">PAN Number File Name 3</th>
	<td><input  disabled type="text" name="pan_card_file_name3" id="pan_card_file_name3"  value="<?php echo $rs['pan_card_file_name3']; ?>" size="40" ></td>
</tr>
...
<?php } else { ?>
	...
	<input type="hidden" name="pan_card_file_name1" id="pan_card_file_name1" value="">
	<input type="hidden" name="pan_card_file_name2" id="pan_card_file_name2" value="">
	<input type="hidden" name="pan_card_file_name3" id="pan_card_file_name3" value="">

<?php }  ?>

	
	<tr>
    	<th align="left">Prefferd Transport</th>
        <td><textarea id="transport" name="transport" rows="4" cols="50" maxlength="200" disabled  ><?php echo $rs['transport']; ?></textarea>
    ...
    <tr>
        ...
        <td><input disabled type="text" name="bank_name" id="bank_name"  value="<?php echo $rs['bank_name']; ?>" size="50"></td>
	</tr>	

	<tr>
    	<th align="left">Branch</th>
        <td><input disabled type="text" name="bank_branch" id="bank_branch" value="<?php echo $rs['bank_branch']; ?>" size="50"></td>
	</tr>	

	<tr>

    	<th align="left">IFSC Code</th>
        <td><input disabled type="text" name="ifsc_code" id="ifsc_code" value="<?php echo $rs['ifsc_code']; ?>" size="25"></td>
	</tr>		

	<tr>
    	<th align="left">Bank City</th>
        <td><input disabled type="text" name="bank_city" id="bank_city" value="<?php echo $rs['bank_city']; ?>" size="25"></td>
	</tr>

	<tr>
    	<th align="left">Bank Account Number</th>
        <td><input disabled type="text" name="bank_account_number" id="bank_account_number" value="<?php echo $rs['bank_account_number']; ?>" size="25"></td>
	</tr>	
	<tr>
    ...
    <tr>
        ...
        <?php
        if($rs['visiting_card']!="") { ?>
			<a href='<?php echo supabase_get_public_url($rs['visiting_card']); ?>' target='_blank'>Visiting Card</a>
            &nbsp;&nbsp;<?php } else { ?>
			 <?php } ?>
        </td>
    </tr>
    <tr>
        ...
        <?php
        if($rs['photo_1']!="") { ?>
			<a href='<?php echo supabase_get_public_url($rs['photo_1']); ?>' target='_blank'>Photo_1</a>
            &nbsp;&nbsp;<?php } else { ?>
			 <?php } ?>
        </td>
    </tr>
    <tr>
        ...
        <?php
        if($rs['photo_2']!="") { ?>
			<a href='<?php echo supabase_get_public_url($rs['photo_2']); ?>' target='_blank'>Photo_2</a>
            &nbsp;&nbsp;<?php } else { ?>
   			 <?php } ?>
        </td>
    </tr>
