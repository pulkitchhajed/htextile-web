...
<tr>
  ...
  <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="address" id="address" size="100"></td>
    </tr>
    <tr>
	...
	<?php }else{ ?>
		...
		<input type="hidden" name="comm_stat_pref" id="comm_stat_pref" value="NotApplicable">
	<?php } ?>
	<tr>
    ...
    <tr>
        ...
        <td><input type="text" name="bank_name" id="bank_name" size="50"></td>
	</tr>	

	<tr>
    	<th align="left">Branch</th>
        <td><input type="text" name="bank_branch" id="bank_branch" size="50"></td>
	</tr>	

	<tr>

    	<th align="left">IFSC Code</th>
        <td><input type="text" name="ifsc_code" id="ifsc_code" size="25"></td>
	</tr>		

	<tr>
    	<th align="left">Bank City</th>
        <td><input type="text" name="bank_city" id="bank_city" size="25"></td>
	</tr>

	<tr>
    	<th align="left">Bank Account Number</th>
        <td><input type="text" name="bank_account_number" id="bank_account_number" size="25"></td>
	</tr>	
	<tr>
