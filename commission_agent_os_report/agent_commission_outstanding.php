...
<title>Commission OS Report Agent</title>
...
<script>
  ...
  function report_submit(){
    ...
    //if(check()){
      document.getElementById('report').action='agent_commission_outstanding.php';
  ...
  function excelDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){
        document.getElementById('report').action='agent_commission_outstanding_report_display_xls.php';
        document.getElementById('report').target="_self";
      //  document.getElementById('report').onsubmit="";
        document.getElementById('report').submit();
    }else{
  ...
  function pdfDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){    
        document.getElementById('report').action='agent_commission_outstanding_report_display_print.php';
    ...
    <td height="326" valign="top">
          ...
          <td valign="top">
            <div class="content_padding">
              <div class="content-header">
                <table width="100%" border='0'><tr><td><h3>Commission OS Agent Wise :</h3></td></tr></table>
              </div>
      ...
      <td>
          <select onchange='downloadLock()' name="agent_account_code" id="agent_account_code">
              ...
              <?php include("agent_commission_outstanding_report_display.php"); ?>   
              <?php } }?>           
            </div>                                 
          </td>
        </tr>
