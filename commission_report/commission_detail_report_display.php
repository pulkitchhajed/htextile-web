...
if($comm_report_type=="PaymentWise"){
    $query_join='JOIN' ;  
}
...
/*
    ...
    */
    ...
    $sql_agent="SELECT firm_name,pan_number,contact_person,pan_card_file_name1,pan_card_file_name2,pan_card_file_name3 FROM txt_company WHERE delete_tag='FALSE' AND company_id IN (SELECT agent_id FROM txt_company WHERE delete_tag='FALSE' AND company_id='$rep_supplier_code')";
    ...
    $pan_card_file_name1=$row_agt['pan_card_file_name1'];
    $pan_card_file_name2=$row_agt['pan_card_file_name2'];
    $pan_card_file_name3=$row_agt['pan_card_file_name3'];
    ...
    }else if($comm_report_type=="PaymentWise"){
    ...
    echo "<tr><td colspan='3'><BR></td><td><BR></td><td>&nbsp;</td><td colspan='4' align='center' ></td></tr>";
    echo "<tr><td colspan='9' align='center'> For any queries please contact Hemant - 09425062020 </td></tr>";
    echo "<tr><td colspan='3'><BR></td><td><BR></td><td>&nbsp;</td><td colspan='4' align='center' ></td></tr>";
    //echo "</table></td></tr>";
    //echo "<tr> <td colspan='9'> <table border='1'>";
...
<table>
  <tr>
    ...
    <?php
      ...
      if((file_exists('../company/agent_pan_doc/'.$pan_card_file_name1))){
      //  if (getimagesize('../company/agent_pan_doc/__PAN_PANKAJ_MIRCHANDANI_PAN.jpg')){
          echo" <img src='../company/agent_pan_doc/$pan_card_file_name1' alt='PAN1' WIDTH='600' HEIGHT='400' >";
        //}
      }
...
<table>
  <tr>
    ...
    //if (trim($pan_card_file_name2 !=''  )) {
      if((file_exists('../company/agent_pan_doc/'.$pan_card_file_name2))){
        //  if (getimagesize('../company/agent_pan_doc/__PAN_PANKAJ_MIRCHANDANI_PAN.jpg')){
            echo" <img src='../company/agent_pan_doc/$pan_card_file_name2' alt='PAN2' WIDTH='600' HEIGHT='400' >";
          //}
      }
    //}
...
?>
  ...
  <tr>
    ...
    <?php
      ...
      if((file_exists('../company/agent_pan_doc/'.$pan_card_file_name3))){
          //  if (getimagesize('../company/agent_pan_doc/__PAN_PANKAJ_MIRCHANDANI_PAN.jpg')){
              echo" <img src='../company/agent_pan_doc/$pan_card_file_name3' alt='PAN3' WIDTH='600' HEIGHT='400' >";
            //}
      }
    //}
    ?>
