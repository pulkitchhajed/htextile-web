...
?>
        ...
        if($main_rs['supporting_doc_1']!="") { ?>
			<a href='<?php echo supabase_get_public_url($main_rs['supporting_doc_1']); ?>' target='_blank'>Supporting Doc 1</a>
		<?php } ?>
        </td>
        ...
        if($main_rs['supporting_doc_2']!="") { ?>
			<a href='<?php echo supabase_get_public_url($main_rs['supporting_doc_2']); ?>' target='_blank'>Supporting Doc 2</a>
 		<?php } ?>
		</td>
		<td colspan='2'></td>
    		</tr>			
