...
<?php /*	
	...
	*/
    ...
    <tr>
		...
		{
?>
			<a href='<?php echo supabase_get_public_url($rs['bill_upload']); ?>' target='_blank'>Bill Copy</a><br>
			<a href='process_bill_entry.php?action=remfile&ft=bill_upload&bill_entry_id=<?php echo $bill_entry_id; ?>' onClick='return del();'>Remove</a>	
<?php			
		} else { ?>
 ...
 <!--       <td><img src="../images/upload_2.png" alt="no image" id="prev0" style="width:25px;height:25px;" name="prev_img1[]" />
		...
		{
?>
			<a href='<?php echo supabase_get_public_url($rs['supporting_doc']); ?>' target='_blank'>Bill Supporting Doc</a><br>
			<a href='process_bill_entry.php?action=remfile&ft=supporting_doc&bill_entry_id=<?php echo $bill_entry_id; ?>' onClick='return del();'>Remove</a>	
<?php			
		} else { ?>
				<img src="../images/upload_2.png" alt="no image" id="prev0" style="width:25px;height:25px;" name="prev_img1[]" />
