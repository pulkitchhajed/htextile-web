...
?>
    ...
    <tr>
        ...
        <?php
        if($rs['bill_upload']!="") { ?>
			<a href='<?php echo supabase_get_public_url($rs['bill_upload']); ?>' target='_blank'>Bill Copy</a>
		<?php 
		} else { ?>
		<?php 
		} ?>
 ...
 <!--       <td><img src="../images/upload_2.png" alt="no image" id="prev0" style="width:25px;height:25px;" name="prev_img1[]" />
		...
		if($rs['supporting_doc']!="") { ?>
			<a href='<?php echo supabase_get_public_url($rs['supporting_doc']); ?>' target='_blank'>Bill Supporting Doc</a>
		<?php 
		} else { ?>
		<?php 
		} ?>
