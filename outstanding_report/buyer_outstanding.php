          ...
          <select onchange='downloadLock()' name="buyer_account_code" id="buyer_account_code">
             <option value="">All</option>
                ...
                <tr>
                  ...
                  <th align="left"> Due Highlight Days </th>
                  
                  <td > 

                  <select name="disp_high" id="disp_high" onchange='downloadLock()'  >

                          <?php
                          $disp_high="";
                          if(isset($_REQUEST['disp_high'])){
                            $disp_high=$_REQUEST['disp_high'];
                          }
 
                          $disp_high_arr=array('No','30','60','90','120','180','210','240','270','300','330');
                    
                          foreach($disp_high_arr as $v)
                          {
                          $selected="";
                    ...
                    &nbsp; &nbsp; <span class="astrik">*</span> No means 365 Days
