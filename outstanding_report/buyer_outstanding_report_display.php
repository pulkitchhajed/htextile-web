...
<tr><td>
	<!-- <table  class="tbl_border_0" border='1' style="background-color:#FFFFFF"> -->
...
$disp_high=$_REQUEST['disp_high'];
if($disp_high=='No'){
  $disp_high='365'; // this needs to highlighted by all means
}
$num_disp_high=number_format($disp_high);
...
/*
        ...
        */
        ...
        if($old_bill_entry_id!=0 && $rs['bill_entry_id']!=$old_bill_entry_id){
          ...
          if( $old_days>$num_disp_high){
            echo "<td align='Right' style='background-color:yellow'><b>";  
            echo $old_days;
            echo "</b></td>";          
