...
<title>Buyer Outstanding Report Interest</title>
...
<script>
  ...
  function report_submit(){
    ...
    //if(check()){
      document.getElementById('report').action='interest_buyer_outstanding.php';
  ...
  function excelDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){
        document.getElementById('report').action='interest_buyer_outstanding_report_display_xls.php';
        document.getElementById('report').target="_self";
      //  document.getElementById('report').onsubmit="";
        document.getElementById('report').submit();
    }else{
  ...
  function pdfDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){    
        document.getElementById('report').action='interest_buyer_outstanding_report_display_print.php';
...
<script type="text/javascript" src="../js/outstanding_report_interest.js"></script>
          ...
          <td valign="top">
            <div class="content_padding">
              <div class="content-header">
                <table width="100%" border='0'><tr><td><h3>Buyer Outstanding Interest :</h3></td></tr></table>
              </div>
          ...
          <select onchange='downloadLock()' name="buyer_account_code" id="buyer_account_code">
             <option value="">All</option>
                ...
                <tr>
                  ...
                  <th>Site (Days) </th>
                  <td><input type="text" name="site_days" size="6" id="site_days" value='<?php echo $site_days ?>' onblur="site_daysChange()" > </td>
                  <td cellpadding="0" cellspacing="0" border="0">
						        <p name="site_days_msg" id="site_days_msg" style="color: red" ></p>
					        </td>

                  <th>Rate of Interest (Monthly) </th>
                  <td><input type="text" name="roi_month" size="6" id="roi_month" value='<?php echo $roi_month ?>' onblur="roi_monthChange()" > </td>
                  <td cellpadding="0" cellspacing="0" border="0">
						        <p name="roi_month_msg" id="roi_month_msg" style="color: red" ></p>
					        </td>
                  <th>
                    Rate of Interst (Per Day)
                  </th>
                  <td>
                    <?php echo $roi_day;?>
                  </td>
