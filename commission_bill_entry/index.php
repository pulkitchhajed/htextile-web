...
<title>Commission Bill Entry </title>
...
function addBillEntry(){
  document.getElementById('bill_index').action='commission_add_bill_entry.php';
...
if(isset($_REQUEST['LastDisplayCount'])){
  ...
  ?>
    <td height="326" valign="top"><table width="100%" style="margin-top:0px" align="center" cellpadding="0" cellspacing="0" border="0">
            ...
            <table width="100%" border='0'><tr><td width='335'><h3>Commisssion Bill Entry :</h3><h4>
...
<table class="tbl_border" width="100%" >
	<tr>
      ...
      <th  valign="top"  width="50">Entry Id</th>  

      <th  valign="top" >Commission Year</th>
      <th  valign="top" >Commission Type</th>
      ...
      <th  valign="top"  width="80">Net Bill Amount (Less GST)</th>
      <th  valign="top"  width="80">Commission Bill Wise</th>


      <th  valign="top"   width="80">Total Payment Amount (Less GST)</th>
      <th  valign="top"  width="80">Commission Payment Wise</th>      
...
if($rs['firm_type']=='Agent'){
  ...
  $ag_array=array($rs['firm_name']=>$rs['company_id']);
  $Agent_array=array_merge($Agent_array,$ag_array);  
}
/*
...
$sql=" select * from (select * from txt_commission_bill_entry 
where delete_tag='FALSE'
 ORDER BY last_update_date desc,commission_bill_entry_id DESC LIMIT 0,".$lastCountSelected." )
...
while($rs=mysqli_fetch_array($result))
{
	$commission_bill_entry_id=$rs[0];
  echo "<tr>";
  
  echo "<td align='left' >".++$count."</td>";
  echo "<td><a href='commission_edit_bill_entry.php?commission_bill_entry_id=$commission_bill_entry_id'><img src='../images/noun_project_edit_1.png' height='16' width='16' border='0' title='Edit' /></a></td>";
  echo "<td><a href='commission_view_bill_entry.php?commission_bill_entry_id=$commission_bill_entry_id'><img src='../images/noun_project_preview_1.png' height='16' width='16' border='0' title='View' /></a></td>";  
  
  echo "<td align='left' >".$rs['commission_bill_entry_id']."</td>";
  echo "<td align='left' >".$rs['commission_year']."</td>";
  //commission_mode
  echo "<td align='left' >".$rs['commission_mode']."</td>";
  echo "<td align='left' >".$rs['commission_bill_number']."</td>";
  echo "<td align='center' >".rev_convert_date($rs['commission_bill_date'])."</td>";
  ...
  */
  ...
  echo "<td align='right' >".zeroToBlank($rs['commission_percent'])."</td>";
  echo "<td align='right' >".$rs['bill_amount_less_gst']."</td>";
  echo "<td align='right' >".$rs['commission_amt_bill']."</td>";

  echo "<td align='right' >".$rs['total_payment_amount_less_gst']."</td>";
