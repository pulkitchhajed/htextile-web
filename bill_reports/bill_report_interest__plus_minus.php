...
<script>
  function bill_report_submit(){
    ...
    document.getElementById('bill_report').action='bill_report_interest__plus_minus.php';
  ...
  function excelDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){    
      document.getElementById('bill_report').action='bill_report_interest__display_plus_minus_xls.php';
      document.getElementById('bill_report').target="_self";
      document.getElementById('bill_report').submit();
    }else{
  ...
  function pdfDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){     
      document.getElementById('bill_report').action='bill_report_interest__display_plus_minus_print.php';
