...
<title>
	<?php echo array_search($header_supplier_code,$Supplier_array); ?> -
	<?php echo array_search($header_buyer_code,$Buyer_array); ?> -
	Payment Report Interest - <?php echo $rep_bill_start_date ;?> - <?php echo $rep_bill_end_date ;?>
	As On -
<?php echo $date?></title>
