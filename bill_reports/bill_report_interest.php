...
<title>Payment Amount Interest</title>
...
<script>
  function bill_report_submit(){
    ...
    document.getElementById('bill_report').action='bill_report_interest.php';
  ...
  function excelDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){    
      document.getElementById('bill_report').action='bill_report_interest_display_xls.php';
      document.getElementById('bill_report').target="_self";
      document.getElementById('bill_report').submit();
    }else{
  ...
  function pdfDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){     
      document.getElementById('bill_report').action='bill_report_interest_display_print.php';
          ...
          <td valign="top">
            <div class="content_padding">
              <div class="content-header">
                <table width="100%" border='0'><tr><td><h3>Payment Amount Interest :</h3></td></tr></table>
              </div>
              ...
              <?php include("bill_report_interest_display.php"); ?>   
              <?php }  }?>           
            </div>                                 
          </td>
        </tr>
