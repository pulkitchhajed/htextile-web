...
<title>Bill Report By Group</title>
...
<script>
  function bill_report_submit(){
    //alert("Hi");
  if ( document.getElementById('supplier_group_id').value =="" &&  document.getElementById('buyer_group_id').value =="" ){
    alert ("Please Select Supplier or Buyer Group");
    document.getElementById('supplier_group_id').focus();

  } else{
    document.getElementById('bill_report').action='buyerlist_asper_supplier_grp.php';
  ...
  function excelDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){    
      document.getElementById('bill_report').action='buyerlist_asper_supplier_grp_xls.php';
      document.getElementById('bill_report').target="_self";
      document.getElementById('bill_report').submit();
    }else{
  ...
  function pdfDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){     
      document.getElementById('bill_report').action='buyerlist_asper_supplier_grp_print.php';
...
$supplier_code="";
if(isset($_REQUEST['supplier_group_id'])){
  $supplier_code=$_REQUEST['supplier_group_id'];
}

$buyer_code="";
if(isset($_REQUEST['buyer_group_id'])){
  $buyer_code=$_REQUEST['buyer_group_id'];
}
          ...
          <td valign="top">
            <div class="content_padding">
              <div class="content-header">
                <table width="100%" border='0'><tr><td><h3>Buyer List By Supplier Group :</h3></td></tr></table>
              </div>
              ...
              <table class="tbl_border">
                <tr>
                  ...
                  <td>
                    <select onchange='downloadLock()' name="supplier_group_id" id="supplier_group_id">
              ...
              <?php include("buyerlist_asper_supplier_grp_display.php"); ?>   
              <?php }  }?>           
            </div>                                 
          </td>
        </tr>
